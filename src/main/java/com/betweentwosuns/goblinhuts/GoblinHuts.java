...
import com.betweentwosuns.goblinhuts.items.GoblinSpear;
...
public class GoblinHuts implements ModInitializer {
	...
	public static final String MOD_ID = "goblinhuts";
	...
	public static final BlockEntityType<GoblinBanneretteTileEntity> GOBLIN_BANNERETTE_ENTITY = Registry.register(
			...
			new Identifier(MOD_ID, "goblin_bannerette_entity"),
	...
	public void onInitialize() {
		...
		Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "goblin_bannerette"), GOBLIN_BANNERETTE);
		Registry.register(Registry.ITEM, new Identifier(MOD_ID, "goblin_bannerette"), GOBLIN_BANNERETTE_BLOCK_ITEM);

		Registry.register(Registry.ITEM, new Identifier(MOD_ID, "goblin_spear"), GoblinSpear.GOBLIN_SPEAR);
	}
}
